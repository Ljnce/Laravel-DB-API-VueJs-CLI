<template>
    <div id="about">
        <div class="min-about">
            <h3> La creazione di questo piccolo progetto, è stata suddivisa in 3 fasi:</h3>
            <h4 style="color:red"> Fasi 1 </h4>
            <ul>
